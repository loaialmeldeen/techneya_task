...
import com.Techneya_task.tests.utils.OSUtils;
import com.Techneya_task.tests.utils.TerminalUtils;
...
import static com.Techneya_task.tests.utils.reports.AllureConstants.HISTORY_FOLDER;
import static com.Techneya_task.tests.utils.reports.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        com.Techneya_task.tests.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(),
                newFileName);
        return newFileName;
    }
